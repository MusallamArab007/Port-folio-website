...
function registration(){
    for (i=1; i<=number1.value; i++)
    {
        ...
        <div><input class="label checkbox" id="one${i}" value="5900" onchange="setPrice${i}(event)" type="checkbox"><label class="chck" for="one${i}">All Access (Deligate) </label><label class="usd1" for="">USD 5900</label></div> 
        <div><input class="label checkbox" id="two${i}" value="5100" onchange="setPrice${i}(event)" type="checkbox"><label class="chck" for="two${i}">Stategic Conference (Deligate) </label><label class="usd2" for="">USD 5100</label></div> 
        <div><input class="label checkbox" id="three${i}" value="1858" onchange="setPrice${i}(event)" type="checkbox"><label class="chck" for="three${i}">Technical Conference Pass - 4 days (Deligate) </label><label class="usd3" for="">USD 1858</label></div> 
        <div><input class="label checkbox" id="four${i}" value="1485" onchange="setPrice${i}(event)" type="checkbox"><label class="chck" for="four${i}">Technical Conference Pass - 2 days (Deligate) </label><label class="usd4" for="">USD 1485</label></div> 
        <div><input class="label checkbox" id="five${i}" value="1100" onchange="setPrice${i}(event)" type="checkbox"><label class="chck" for="five${i}">Downstream Technical Conference Pass (Deligate) </label><label class="usd5" for="">USD 1100</label></div> 
        <hr align="left">
    </div>`
    }
}
